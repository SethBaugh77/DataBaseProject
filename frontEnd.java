...
public class frontEnd {
        ...
        if (inp == 1) {
            ...
            for(int i = 0 ; i < names.size(); i++)
            {
                if(names.get(i).getLname().equalsIgnoreCase(who))
                {
                    ...
                    break;
                    // System.out.println("Case Severity(1-5): " +names.get(i).getHeight());
                    // System.out.println("Is Case solved?: " + names.get(i).getID());
            ...
            if(ans6.equalsIgnoreCase("Y" ) || ans6.equalsIgnoreCase("Yes" ))
            {
                ...
                //long ID = ThreadLocalRandom.current().nextInt(3000, 3997 + 1);
                Evidence evidence = new Evidence(ID, vehicleEvidence, bloodEvidence, fingerPrintEvidence, weaponEvidence);
    ...
    public Person addPerson(DataBase dbase, int inp2) {
        ...
        if (inp2 == 1) {
            ...
            System.out.println(
                    "1. firstName 2. lastName 3. height 4. weight 5. gender 6. address 7. phone 8. DOB 9. Adult?");
            System.out.println("10. occupation? 11. lastLocation 12. age 13. body type, 14. Race 15. Criminal 16. Tatoos 17. Notes");
            ...
            //{//
                ...
                //{
                    ...
                    for(int k = 0 ; k < _case.getCriminals().size();k++)
                    {
                        ...
                        {
                            System.out.println(dBase.getCriminals().get(i).getFname() + dBase.getCriminals().get(i).getLname());
                        }
                    }
                    }
                    for(int k = 0 ; k < _case.getOfficers().size();k++)
                    {
                        ...
                        {
                            System.out.println(dBase.getOfficers().get(i).getFname() + dBase.getOfficers().get(i).getLname());
                        }
                    }
                    }
                    for(int k = 0 ; k < _case.getSuspects().size();k++)
                    {
                        ...
                        {
                            System.out.println(dBase.getSuspects().get(i).getFname() + dBase.getSuspects().get(i).getLname());
                        }
                    }
                    }
                    ...
                    for(int k = 0 ; k < _case.getWitnesses().size();k++)
                    {
                        ...
                        {
                            System.out.println(dBase.getWitnesses().get(i).getFname() + dBase.getWitnesses().get(i).getLname());
                        }
                    }
                    }
