...
public class Suspect extends PersonOfInterest {
    ...
    public Suspect(String name, int age, int height, int weight, String gender, String address, String phone,
            String dateOfBirth, boolean isAdult, int id, String occupation, String crimeConnectionString,
            String lastLocation, String bodyType, boolean isCriminal, ArrayList<Suspect> relatives) {
        super(name, age, height, weight, gender, address, phone, dateOfBirth, isAdult, id, occupation,
